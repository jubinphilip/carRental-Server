...
const editUserSchema = Joi.object({
  userid:Joi.string(),
  username: Joi.string().min(3).max(30).regex(/^[a-zA-Z\s]+$/).messages({
      'string.base': 'Username must be a string',
      'string.empty': 'Username cannot be empty',
      'string.min': 'Username must be at least 3 characters long',
      'string.max': 'Username must be at most 30 characters long',
  ...
  city: Joi.string().min(2).max(50).pattern(/^[A-Za-z\s]+$/).messages({
      'string.base': 'City must be a string',
      'string.empty': 'City cannot be empty',
      'string.min': 'City must be at least 2 characters long',
      'string.max': 'City must be at most 50 characters long',
  ...
  state: Joi.string().min(2).max(50).pattern(/^[A-Za-z\s]+$/).messages({
      'string.base': 'State must be a string',
      'string.empty': 'State cannot be empty',
      'string.min': 'State must be at least 2 characters long',
      'string.max': 'State must be at most 50 characters long',
  ...
  country: Joi.string().min(2).max(50).pattern(/^[A-Za-z\s]+$/).messages({
      'string.base': 'Country must be a string',
      'string.empty': 'Country cannot be empty',
      'string.min': 'Country must be at least 2 characters long',
      'string.max': 'Country must be at most 50 characters long',
  ...
  pincode: Joi.string().pattern(/^[0-9]{5,6}$/).messages({
      'string.base': 'Pincode must be a string of digits',
      'string.empty': 'Pincode cannot be empty',
      'string.pattern.base': 'Pincode must be a valid 5 or 6 digit number',
  }).optional(), 

  password: Joi.string().min(8).max(30).regex(/^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])(?=.*[\W_]).+$/).messages({
      'string.base': 'Password must be a string',
      'string.empty': 'Password cannot be empty',
      'string.min': 'Password must be at least 8 characters long',
      'string.max': 'Password must be at most 30 characters long',
